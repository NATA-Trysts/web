...
export const KeyboardShortcuts = () => {
  ...
  const goToShortcut = (index: number) => {
    ...
    const shortcut = wrapperRef.current.querySelector<HTMLButtonElement>(`button:nth-child(${index + 1})`)
  ...
  const goToNextShortcut = () => goToShortcut((activeShortcutIndexRef.current + 1) % Shortcuts.length)
