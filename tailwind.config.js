...
module.exports = {
  ...
  theme: {
    ...
    backgroundImage: {
      ...
      'primary-gradient': 'linear-gradient(85.46deg, #A67BC2 0%, #C771E1 50.52%, #E9A8FA 100%)',
    ...
    fontFamily: {
      ...
      // sans: '"General Sans", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif',
    },
    fontSize: {
      xs: '1.3rem',
      sm: '1.4rem',
